# nvim-treesitter-queries-squirrel

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-squirrel/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-squirrel/actions/workflows/validate.yml)

Neovim tree-sitter queries for **squirrel**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-squirrel",
...
- [ ] Changes are scoped to `squirrel` — do not include files for other languages
